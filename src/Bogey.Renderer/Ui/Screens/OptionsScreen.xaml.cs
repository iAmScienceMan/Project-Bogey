...
public sealed partial class OptionsScreen : Control
{
    ...
    {
        AddTextRow(BasicPage, "CALLSIGN", CVars.PlayerCallsign);
    ...
    private void BuildAdvancedPage()
    {
        ...
        AddTextRow(AdvancedPage, "IDENTIFY THRESHOLD", CVars.SimIdentifyThreshold);
        AddTextRow(AdvancedPage, "POS ERROR BASE (KM)", CVars.SimPositionalErrorBase);
        AddTextRow(AdvancedPage, "OBSERVATION NOISE (KM)", CVars.SimObservationNoise);
        AddTextRow(AdvancedPage, "DECAY FACTOR", CVars.SimDecayFactor);
        AddTextRow(AdvancedPage, "POS ERROR GROWTH (KM)", CVars.SimPositionalErrorGrowth);
        AddTextRow(AdvancedPage, "STALE AFTER (TICKS)", CVars.SimStaleTicks);
        AddTextRow(AdvancedPage, "DROP AFTER (TICKS)", CVars.SimDropTicks);
