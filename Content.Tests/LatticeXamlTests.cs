...
public sealed class BogeyXamlTests
{
    ...
    {
        Control root = LatticeXaml.Parse(Sample, out NameScope scope);
    ...
    public void Parse_UnknownElement_Throws()
    {
        Assert.Throws<InvalidOperationException>(() =>
            LatticeXaml.Parse("<Control xmlns=\"bogey\"><Widget /></Control>", out _));
    }
    ...
    {
        Assert.Throws<InvalidOperationException>(() =>
            LatticeXaml.Parse("<Control xmlns=\"bogey\"><Button Bogus=\"1\" /></Control>", out _));
    }
}
